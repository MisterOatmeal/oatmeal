...
--- @field AddTransientStrategy fun(name: string, strategyName: string, description: string, code: string): boolean
--- @field AddTransientStrategyTargetEnemyOID fun(): nil

--- @class Automaton
--- @field IsTweakEnabled fun(className: string): boolean
--- @field SetTweakState fun(className: string, state: boolean): nil
...
--- @field GetActiveCustomAetheryte fun(): number
...
--- @field GetNumberOfInstances fun(): number
...
--- @field MoveTo fun(waypoints: table<Vector3>, fly: boolean): nil
--- @field Stop fun(): nil
...
--- @field GetConfigEnabled fun(featureName: string, configPropName: string): boolean?
--- @field SetFeatureEnabled fun(featureName: string, state: boolean): nil
--- @field SetConfigEnabled fun(featureName: string, configPropName: string, state: boolean): nil
...
--- @field SetAutoRotationState fun(leaseId: object, enabled: boolean): SetResult
--- @field IsCurrentJobAutoRotationReady fun(): boolean
--- @field SetCurrentJobAutoRotationReady fun(leaseId: object): SetResult
--- @field ReleaseControl fun(leaseId: object): nil
--- @field GetComboNamesForJob fun(jobId: number): table<string>
--- @field GetComboOptionNamesForJob fun(jobId: number): object
--- @field SetComboState fun(leaseId: object, comboInternalName: string, newComboState: boolean, newComboAutoModeState: boolean): SetResult
--- @field GetComboState fun(comboInternalName: string): object
--- @field SetComboOptionState fun(leaseId: object, optionInternalName: string, newOptionState: boolean): SetResult
--- @field GetComboOptionState fun(optionInternalName: string): boolean
--- @field GetAutoRotationConfigState fun(configOption: AutoRotationConfigOption): object
--- @field SetAutoRotationConfigState fun(leaseId: object, configOption: AutoRotationConfigOption, configValue: object): SetResult
--- @field Register fun(scriptName: string): object?
